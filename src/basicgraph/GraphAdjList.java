...
public class GraphAdjList extends Graph {
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 if (v < 0 || v >= adjListsMap.keySet().size())
		 	throw new IndexOutOfBoundsException();

		 ArrayList<Integer> twoHops = new ArrayList<>();
		 ArrayList<Integer> oneHops = adjListsMap.get(v);

		 for (Integer oneHop : oneHops) {
			 twoHops.addAll(adjListsMap.get(oneHop));
		 }
